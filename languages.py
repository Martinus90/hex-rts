...
class Language:
    def __init__(self):
        if LANGUAGE == "EN":
            ...
            self.GUI = ["Nearby resources: ", "Extraction", "Working", "Waiting", "Resources:", "Building", "Production:", "Population:"]
            ...
            self.GUI = ["Pobliskie zasoby: ", "Wydobycie", "Pracuje", "Czeka", "Zasoby:", "Budynek", "Produkcja:", "Populacja:"]
